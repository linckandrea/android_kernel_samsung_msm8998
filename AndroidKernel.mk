...
KERNEL_DEFCONFIG += VARIANT_DEFCONFIG=$(VARIANT_DEFCONFIG) DEBUG_DEFCONFIG=$(DEBUG_DEFCONFIG) SELINUX_DEFCONFIG=$(SELINUX_DEFCONFIG) SELINUX_LOG_DEFCONFIG=$(SELINUX_LOG_DEFCONFIG) KASLR_DEFCONFIG=$(KASLR_DEFCONFIG)
endif
...
=======
	...
	$(mv-modules)
	$(clean-module-folder)
>>>>>>> 15e8ca07a9b38f8eb0fa8791d320b8c8b74762dc
